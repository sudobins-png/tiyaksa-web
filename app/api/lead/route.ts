  ...
  if (raw.fromQuiz === true && aptType && area) {
    try {
      ...
      const offerText = [
        ...
        '',
        'Когда будете готовы — можем согласовать замер, обсудить на нем стиль интерьера, материалы, после чего в течение дня смогу выслать предложение и назвать точную цену. Пишите сюда в любое удобное время.',
      ].join('\n');
