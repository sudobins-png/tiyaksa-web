...
import { fetchPostBySlug, getArticleJsonLd, getFeaturedImage, getMetaDescription, stripHtml, stripDuplicateTocHeading } from '@/lib/server/wordpress';
    ...
    <>
      ...
      <main style={{ paddingTop: '71px' }} className="min-h-dvh bg-site">
        <article className="max-w-[760px] mx-auto px-6 py-12 sm:py-16">
          ...
          <div className="article-content" dangerouslySetInnerHTML={{ __html: stripDuplicateTocHeading(post.content.rendered) }} />
        </article>
      </main>
      <Footer />
    </>
